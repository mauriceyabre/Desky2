                          ...
                          <div class="scroll-y mh-200px mh-lg-350px">
                            ...
                            >
                              <div class="symbol symbol-40px me-4">
                                <img
                                  :src="
                                    getAssetPath('media/avatars/300-6.jpg')
                                  "
                                  alt=""
                                />
                              </div>
                            ...
                            >
                              <div class="symbol symbol-40px me-4">
                                <img
                                  :src="
                                    getAssetPath('media/avatars/300-2.jpg')
                                  "
                                  alt=""
                                />
                              </div>
                            ...
                            >
                              <div class="symbol symbol-40px me-4">
                                <img
                                  :src="
                                    getAssetPath('media/avatars/300-9.jpg')
                                  "
                                  alt=""
                                />
                              </div>
                                ...
                                <span class="symbol-label bg-light">
                                  ...
                                  >
                                    <inline-svg
                                      :src="
                                        getAssetPath(
                                          '/media/icons/duotune/general/gen032.svg'
                                        )
                                      "
                                    />
                                  </span>
                                ...
                                <span class="symbol-label bg-light">
                                  ...
                                  >
                                    <inline-svg
                                      :src="
                                        getAssetPath(
                                          '/media/icons/duotune/communication/com012.svg'
                                        )
                                      "
                                    />
                                  </span>
                              ...
                              >
                                <span class="svg-icon svg-icon-1">
                                  <inline-svg
                                    :src="
                                      getAssetPath(
                                        '/media/icons/duotune/coding/cod001.svg'
                                      )
                                    "
                                  />
                                </span>
                                ...
                                <span class="symbol-label bg-light">
                                  ...
                                  >
                                    <inline-svg
                                      :src="
                                        getAssetPath(
                                          '/media/icons/duotune/electronics/elc004.svg'
                                        )
                                      "
                                    />
                                  </span>
                                ...
                                <span class="symbol-label bg-light">
                                  ...
                                  >
                                    <inline-svg
                                      :src="
                                        getAssetPath(
                                          '/media/icons/duotune/graphs/gra001.svg'
                                        )
                                      "
                                    />
                                  </span>
                                ...
                                <span class="symbol-label bg-light">
                                  ...
                                  >
                                    <inline-svg
                                      :src="
                                        getAssetPath(
                                          '/media/icons/duotune/graphs/gra003.svg'
                                        )
                                      "
                                    />
                                  </span>
                                ...
                                <span class="symbol-label bg-light">
                                  ...
                                  >
                                    <inline-svg
                                      :src="
                                        getAssetPath(
                                          '/media/icons/duotune/communication/com010.svg'
                                        )
                                      "
                                    />
                                  </span>
                                ...
                                <span class="symbol-label bg-light">
                                  ...
                                  >
                                    <inline-svg
                                      :src="
                                        getAssetPath(
                                          '/media/icons/duotune/graphs/gra002.svg'
                                        )
                                      "
                                    />
                                  </span>
                          ...
                          <div class="pt-10 pb-10">
                            <span class="svg-icon svg-icon-4x opacity-50">
                              <inline-svg
                                :src="
                                  getAssetPath(
                                    '/media/icons/duotune/files/fil024.svg'
                                  )
                                "
                              />
                            </span>
